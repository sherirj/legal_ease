...
class FirmRecentMessagesPage extends StatelessWidget {
  const FirmRecentMessagesPage({super.key});

  Future<Map<String, String>> _getOtherUserInfo(String otherUid) async {
    try {
      // Try to get lawyer info
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: const [
              Icon(Icons.business_outlined, color: Colors.white38, size: 64),
              SizedBox(height: 16),
              Text(
                'Not signed in',
              ...
              SizedBox(height: 8),
              Text(
                'Please log in to view firm messages',
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // Sort chats manually by lastMessageAt
                chats.sort((a, b) {
                  final aTime = (a.data() as Map<String, dynamic>)['lastMessageAt'];
                  final bTime = (b.data() as Map<String, dynamic>)['lastMessageAt'];
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'Start conversations with clients and lawyers',
                          style: TextStyle(color: Colors.white54, fontSize: 14),
                        ),
                      ],
                    ),
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final storedFirmName = chatData['firmName'];
                    ...
                    return FutureBuilder<Map<String, String>>(
                      ...
                      builder: (context, userSnapshot) {
                        ...
                        if (storedLawyerName != null && 
                            storedLawyerName.isNotEmpty) {
                          displayName = storedLawyerName;
                        } else if (storedClientName != null && 
                                   storedClientName.isNotEmpty) {
                          displayName = storedClientName;
                        } else if (storedFirmName != null && 
                                   storedFirmName.isNotEmpty) {
                          displayName = storedFirmName;
                        }
